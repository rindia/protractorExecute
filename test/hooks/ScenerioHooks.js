...
cucumber_1.defineSupportCode(function (_a) {
    ...
    registerHandler("BeforeScenario", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, protractor_1.browser.get(config_1.config.baseUrl)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    registerHandler("AfterScenerio", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/];
        });
    }); });
...
//# sourceMappingURL=ScenerioHooks.js.map