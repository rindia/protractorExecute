...
var ExcelUtil_1 = require("../Utilies/ExcelUtil");
var Locators = {
    username: {
...
var LoginPage = /** @class */ (function (_super) {
    ...
    LoginPage.prototype.goLogin = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ElementLocator(Locators.username).sendKeys("angular")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.ElementLocator(Locators.password).sendKeys("password")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.ElementLocator(Locators.anotherName).sendKeys("rohit saini")];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.ElementLocator(Locators.loginBtn).click()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LoginPage.prototype.GetJsonData = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, json("../dataJson/data.json").then(function (x) {
                            console.log(x);
    ...
    LoginPage.prototype.GetDataFromExcel = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sheet, name;
            return __generator(this, function (_a) {
